...
| Job templates (5 seed jobs) | 🚧 in progress | 2026-08-28 · 4/5 shipped: aire mini-split (4 fixtures), ducha/calentador (3), tomacorriente 240 V (3), tomas/iluminación adicional (3: chequeo 314.16 por punto vía `boxFill`, GFCI feed-through en la primera toma, cantidades por punto con `perCount`); sweep de alcanzabilidad presets×choices en CI |
